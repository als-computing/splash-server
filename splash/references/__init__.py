...
# The bottom models are too strict for all the data
# we will be taking in. It is NOT being used, but I'm
# keeping it here just to look at
class NewReferenceCSL(BaseModel):
...
NewReferenceCSL.update_forward_refs()
